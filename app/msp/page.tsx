...
const filters = ['All', 'Kharif', 'Rabi', 'Both'] as const;
  ...
  const filteredCrops = useMemo(() => {
    ...
    return MSP_DATA.filter((crop) => {
      const matchesSearch =
        ...
        crop.tamilName.includes(search);
    ...
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-semibold text-soil">
              MSP Prices 2026-27
            </h1>

            <p className="font-tamil text-lg text-paddy">
              குறைந்தபட்ச ஆதரவு விலை 2026-27
            </p>

            <p className="text-sm text-soil/60 mt-1">
              Government guaranteed minimum prices for major Tamil Nadu crops.
            </p>
          </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap ${
                      filter === item
                        ...
                        : 'bg-white border border-straw text-soil hover:border-turmeric'
                    }`}
                  >
                    {item}
                  </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {filteredCrops.map((crop, index) => (
              ...
              <motion.div
                ...
                className="bg-white rounded-xl border border-straw shadow-sm p-5"
              >

                <div className="flex items-start justify-between gap-3">

                  <div>
                    <h2 className="font-semibold text-soil">
                      {crop.crop}
                    </h2>
                  ...
                  <span className="px-3 py-1 rounded-full text-xs bg-paddy-light text-paddy">
                    {crop.season}
                  </span>
                ...
                <div className="mt-6 flex items-end justify-between">
                  ...
                  <div>
                    <p className="text-3xl font-semibold text-paddy">
                      Rs. {crop.mspPerQuintal.toLocaleString('en-IN')}
                    </p>
